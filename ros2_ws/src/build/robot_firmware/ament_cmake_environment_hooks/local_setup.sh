...
: ${AMENT_CURRENT_PREFIX:="/home/adhamwalaa/ros2_ws/src/install/robot_firmware"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_firmware/environment/library_path.sh"
